...
model.riclpm <- '
            ########################## RI_CLPM MODEL ###########################
            # This is the third model to test different levels of constraint.
            # In this version intercepts are not only added for all of the 
            # question variables, but they are also set to the same value. 
            # In other words, the intercept of a question is defined to be the
            # same at all measurement times. 
            ...
            # Next we determine the variance and covariance of the random ints
            RI.a ~~ RI.a
            RI.wb ~~ RI.wb
            RI.a ~~ RI.wb
...
scalar.fit <- cfa(model.scalar, data = data, 
