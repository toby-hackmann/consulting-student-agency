...
model.residual <- '
            ######################## RESIDUAL MODEL ############################
            # This is the final nested model, testing for the most rigorous
            # constraints. The added constraint here is that the residuals for
            # the questions remain constant over time
            ...
            Cijfers.1 ~~ 1*Cijfers.1
            Cijfers.2 ~~ 1*Cijfers.2
            Cijfers.3 ~~ 1*Cijfers.3


            ## This is the residual model, so we fix the variances of the
            ## questions to the same value, no matter what time point.
            VM1.1 ~~ vm1v*VM1.1
            VM1.2 ~~ vm1v*VM1.2
            VM1.3 ~~ vm1v*VM1.3
            VM2.1 ~~ vm2v*VM2.1
            ...
            SRf9.2 ~~ srf9v*SRf9.2
            SRf9.3 ~~ srf9v*SRf9.3
            SRf10.1 ~~ srf10v*SRf10.1
            SRf10.2 ~~ srf10v*SRf10.2
            SRf10.3 ~~ srf10v*SRf10.3
            SRf11.1 ~~ srf11v*SRf11.1
            SRf11.2 ~~ srf11v*SRf11.2
            SRf11.3 ~~ srf11v*SRf11.3
            ...
            Grades.1 ~~ cijfv*Grades.1
            Grades.2 ~~ cijfv*Grades.2
            Grades.3 ~~ cijfv*Grades.3
